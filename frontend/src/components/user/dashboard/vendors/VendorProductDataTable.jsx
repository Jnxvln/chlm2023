...
function VendorProductDataTable({ vendors, vendorProducts, vendorProductsLoading }) {
  // #region VARS -------------------------------
    ...
    <div className="datatable-templating-demo">
      ...
      <div className="card" style={{ height: "calc(100vh - 145px)" }}>
        ...
        >
          ...
          {/* PRODUCT COST */}
          <Column field="productCost" dataType="number" header="Product Cost" body={vendorProductProductCostTemplate} sortable></Column>
