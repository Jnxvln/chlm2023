...
export default function AdminDashboard() {
   ...
   const onToggleAdvertiseDeliveries = (e) => {
      console.log('[AdminDashboard.jsx onToggleAdvertiseDeliveries] event: ')
      console.log(e)

      setAllowUpdate(true)
      setSettingsTemplate((prevState) => ({
         ...prevState,
         advertiseDeliveries: !prevState.advertiseDeliveries,
      }))
   }
   // #endregion
         ...
         switch (menuItemSelected) {
            case 'messages':
               ...
               document.getElementById('panelSiteMessages').style.display =
                  'block'
               document.getElementById('panelOperatingHours').style.display =
                  'none'
   ...
   useEffect(() => {
      if (siteMessageSelected) {
         ...
         setInputSiteMessageDateStart(new Date(siteMessageSelected.dateStart))
   ...
   useEffect(() => {
      if (userUpdateInfo && allowUpdateUser) {
         ...
         console.log('[AdminDashboard useEffect update user info] Updating...')
      ...
      <div>
            ...
            <div>
               ...
               <div className="field">
                  <span className="p-float-label">
                     <InputText
                        ...
                        autoFocus
                     />
                     <label htmlFor="dialogInput_SiteMessage_Page">Page</label>
                  </span>
               </div>
               ...
               <div className="flex align-items-center">
                  <Checkbox
                     ...
                     onChange={(e) => setInputSiteMessageIsActive(e.checked)}
               ...
               <div className="field">
                  <span className="p-float-label">
                     <InputText
                        ...
                        style={{ width: '100%' }}
                     />
                     <label htmlFor="dialogInput_User_Email">E-mail:</label>
                  </span>
               </div>
            </div>
         </Dialog>
         ...
         <div className={styles.adminPanelWrapper}>
            ...
            <div className={styles.adminPanel}>
               {/* STORE SETTINGS */}
               <div className={styles.settingsSubtitle}>Store Settings</div>
               <div className={styles.storeSettingsWrapper}>
                  ...
                  {!settingsTemplate.storeOpen && (
                     <div className="flex flex-column gap-2">
                        <InputTextarea
                           ...
                           onChange={(e) => onChangeStoreClosedReason(e)}
                  ...
                  <div className={styles.storeOpenClosedWrapper}>
                     ...
                     <div id="adminDashboardStoreOpenSwitch">
                        <InputSwitch
                           checked={settingsTemplate.advertiseDeliveries}
                           onChange={(e) => onToggleAdvertiseDeliveries(e)}
                        />
                     </div>
                  </div>
               </div>
            ...
            <div className={styles.adminContentPanel}>
               ...
               >
                  ...
                  >
                     ...
                     />
                     <Column header="Actions" body={messagesActionTemplate} />
                  </DataTable>
               </section>
                  ...
                  <form onSubmit={onSubmitHours}>
                     ...
                     <div className="field">
                        <span className="p-float-label">
                           ...
                           />
                           <label htmlFor="monFriHours">Mon - Fri</label>
                        </span>
                     </div>
