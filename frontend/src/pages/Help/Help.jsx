                        ...
                        <div className={styles.relatedLinks}>
                            {selectedFaq &&
                                ...
                                selectedFaq.urls.map((link, index) => (
                                    <div
                                        key={index}
                                        className={styles.helpRelatedLink}
                                    >
                                        <a
                                            href={link.url}
                                            target={
                                                link.isExternal ? '_blank' : ''
                                            }
                                            rel={
                                                link.isExternal
                                                    ? 'noopener'
            ...
            <section className={styles.generalInformationSection}>
                ...
                <div className="flex justify-content-evenly flex-wrap">
                    ...
                    <div className={styles.materialTypeBulk}>
                        ...
                        <h3 className={styles.materialTypeTitle}>
                            Bulk (Loose)
                        </h3>
                        ...
                        <div className={styles.loaderWrapper}>
                            <div className={styles.loadedWithText}>
                                Loaded with
                            </div>
                ...
                <div className={styles.weightsParent}>
                    ...
                    <div className={styles.weightsPalletSection}>
                        ...
                        <p className={styles.weightsParagraph}>
                            Pallet weights vary greatly; thinner flagstone, like
                            1” and 1”minus tend to weigh less, around 2,500lbs -
                            3,500lbs.
                        </p>
                        <p className={styles.weightsParagraph}>
                            1.5” and 2” flagstone, and most creek rock and
                            fieldstone pallets tend to run 3,500lbs - 4,000lbs.
                            Chopped stone can be even heavier, usually 3,700lbs
                            - 4,300lbs.
                        </p>
                    </div>
                </div>
            ...
            <section className={styles.coverageSection}>
                ...
                <div className={styles.stoneSection}>
                    ...
                    <div className={styles.bulkRectangleWrapper}>
                        ...
                        <p>
                            For <strong>square</strong> and{' '}
                            <strong>rectangle</strong> shaped projects, you can
                            use the following formula to approximate how much
                            you need:
                        </p>
                        ...
                        <div>
                            ...
                            <div className={styles.bulkFormulaDisclaimer}>
                                NOTE: Length and Width must be in{' '}
                                <strong>feet</strong>. Depth must be in{' '}
                        ...
                        <div>
                            ...
                            calculator) and add an additional 1/2yd - 1yd.
                            Basically, the larger the material, the lesser the
            ...
            <section className={styles.loadingInfoSection}>
                ...
                <div className={styles.loadingInfoSubsection}>
                    ...
                    <div>
                        ...
                        (topsoil, sand, and gravels) into the bed, or usually 1
                        yard of the lighter materials (compost and mulch.)
                        Low-pressure tires carry less and are potentially
                        dangerous.
                    </div>
                    ...
                    <div>
                        We can usually load 1 yard of our heavy materials
                        (topsoil, sand, and gravels) into the bed, or 1.5 to 2
                        yards of the lighter materials (compost and mulch.)
                        Low-pressure tires carry less and are potentially
                        dangerous.
                    </div>
                    ...
                    <div>
                        ...
                        number of axles your trailer has, the length of your
                        trailer, the condition of your tires, and whether or not
                        you bring a tarp or have sides you can put on your
                        trailer (to contain loose materials.) Low-pressure tires
                        carry less and could be potentially dangerous.
                    </div>
                    ...
                    <div>
                        Typical trailer axles are rated to carry about 3,500 lbs
                        per axle (7,000 lbs total for trailers with two axles,
                        also called dual axle or tandem axle.)
                    </div>
                    <br />
                    <div>
                        Check the weights section above to find out how heavy
                        the material is that you want to load onto your trailer.
                    </div>

                    <div className={styles.coverageSubTitle}>TARPS & SIDES</div>

                    <div>
                        Please bring a tarp with straps OR put sides on your
                        trailer when you buy our bulk materials. This will help
                        ensure you don’t lose product while driving down the
                        road, potentially causing harm to other drivers!
                    </div>
                    ...
                    <div>
                        <strong>
                            <u>
                                We are not responsible for any material lost
                                while driving.
                            </u>{' '}
                            You also put others at risk on the road when you
                            have gravel or other material flying off the
                            trailer. Please tarp your load or put sides on your
