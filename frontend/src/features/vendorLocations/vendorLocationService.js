...
const getVendorLocations = async (token) => {
  const config = {
    headers: {
...
const createVendorLocation = async (vendorLocationData, token) => {
  const config = {
    headers: {
      Authorization: `Bearer ${token}`,
    },
...
const updateVendorLocation = async (vendorLocationData, token) => {
  const config = {
    headers: {
      Authorization: `Bearer ${token}`,
    },
...
const deleteVendorLocation = async (vendorLocationId, token) => {
  const config = {
    headers: {
      Authorization: `Bearer ${token}`,
    },
